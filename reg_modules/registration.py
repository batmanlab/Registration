...
class Register:
    ...
    def __init__(self, fixed_img, moving_img, lr_swap=True, verbose=True):
        self.verbose = verbose
        self.fixed_img = fixed_img
        self.moving_img = moving_img
        if lr_swap:
            self.moving_img.CopyInformation(self.fixed_img)
        self.gen_param_map()
        self.register_imgs()
    ...
    def gen_param_map(self):
        ...
        pbsp['FinalGridSpacingInPhysicalUnits'] = ['8', '8']
